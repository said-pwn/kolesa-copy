...
const Navbar = () => {
  ...
  const handleSubmitAd = () => {
    if (currentUser) navigate("/submit-ad");
  ...
  const LanguageDropdown = () => (
    <div className="relative">
      <button
        className="border px-3 py-1 rounded-lg cursor-pointer text-sm lg:text-base flex items-center justify-center"
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 shadow-md flex justify-around items-center py-2 md:hidden z-40">
        ...
        >
          <PlusCircle size={24} />
          <span className="text-xs">{texts.submitAd}</span>
        </button>
